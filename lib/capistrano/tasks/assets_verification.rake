      ...
      within release_path do
        ...
        if manifest_files.empty?
          ...
          critical_assets.each do |asset|
            unless manifest_content.include?(asset)
    ...
    on roles(:app) do
      within release_path do
        ...
        if assets_count > 5  # 应该有多个资源文件
          ...
          aa_files = capture(:ls, "#{shared_path}/public/assets/", '|', :grep, 'active_admin', raise_on_non_zero_exit: false)
