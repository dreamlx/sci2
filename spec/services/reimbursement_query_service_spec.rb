...
RSpec.describe ReimbursementQueryService, type: :service do
  ...
  # 创建分配
  let!(:assignment1) { create(:reimbursement_assignment, reimbursement: reimbursement1, assignee: admin_user, is_active: true) }
  let!(:assignment2) { create(:reimbursement_assignment, reimbursement: reimbursement2, assignee: other_admin_user, is_active: true) }
  # reimbursement3 没有分配
