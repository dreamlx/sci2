...
RSpec.describe AuditWorkOrderRepository, type: :repository do
  ...
  # 使用共享测试示例
  it_behaves_like 'basic work order repository', AuditWorkOrderRepository, AuditWorkOrder, :audit_work_order
  it_behaves_like 'intelligent status queries', AuditWorkOrderRepository, AuditWorkOrder

  # AuditWorkOrder特有的测试用例
  describe 'audit result queries' do
  ...
  describe 'VAT verification queries' do
  ...
  describe 'status queries (audit-specific)' do
  ...
  describe 'audit date queries' do
  ...
  describe 'audit-specific counting methods' do
  ...
  describe 'audit-specific search functionality' do
  ...
  describe 'audit-specific ordering queries' do
  ...
  describe 'audit-specific existence checks' do
  ...
  describe 'audit-specific association handling' do
  ...
  describe 'reimbursement association queries (audit-specific)' do
