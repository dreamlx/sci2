...
RSpec.describe "完整工单处理流程", type: :system, js: true do
  ...
  # 创建费用明细
  let!(:fee_detail1) { create(:fee_detail, document_number: 'R202501001', fee_type: '交通费', amount: 100.00, verification_status: 'pending') }
  let!(:fee_detail2) { create(:fee_detail, document_number: 'R202501001', fee_type: '住宿费', amount: 200.00, verification_status: 'pending') }
  let!(:fee_detail3) { create(:fee_detail, document_number: 'R202501001', fee_type: '餐饮费', amount: 150.00, verification_status: 'pending') }
