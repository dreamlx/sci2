...
FactoryBot.define do
  factory :work_order do
    ...
    factory :audit_work_order, class: 'AuditWorkOrder' do
      ...
      after(:build) do |audit_work_order, _evaluator|
        # 如果没有设置fee_detail_ids_to_select，则设置一个空数组
        unless audit_work_order.instance_variable_get('@fee_detail_ids_to_select')
          audit_work_order.instance_variable_set('@fee_detail_ids_to_select',
                                                 [])
        end
      end
