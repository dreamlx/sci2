...
RSpec.describe ExpressReceiptWorkOrder, type: :model do
  ...
  describe "filling_id generation" do
    ...
    it "generates filling_id during validation" do
      work_order = build(:express_receipt_work_order, reimbursement: reimbursement, tracking_number: "SF1234", received_at: Time.current)
    ...
    it "uses FillingIdGenerator to generate filling_id" do
      ...
      work_order = build(:express_receipt_work_order, reimbursement: reimbursement, tracking_number: "SF1234", received_at: current_time)
