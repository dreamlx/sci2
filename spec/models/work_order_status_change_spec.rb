...
RSpec.describe WorkOrderStatusChange, type: :model do
  ...
  # Scopes
  describe "scopes" do
    let!(:audit_change) { create(:work_order_status_change, work_order: create(:audit_work_order), work_order_type: 'AuditWorkOrder') }
    let!(:communication_change) { create(:work_order_status_change, work_order: create(:communication_work_order), work_order_type: 'CommunicationWorkOrder') }
