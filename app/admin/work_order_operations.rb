...
ActiveAdmin.register WorkOrderOperation do
  ...
  controller do
    ...
    def find_collection
      ...
      collection = collection.where(work_order_id: params[:communication_work_order_id]) if params[:communication_work_order_id]
      collection = collection.where(work_order_id: params[:express_receipt_work_order_id]) if params[:express_receipt_work_order_id]
      collection
    end
  end
